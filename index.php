...
$rule->substitutions['Saft\\Data\\ParserFactory'] = new \Dice\Instance('Saft\\Backend\\EasyRdf\\Data\\ParserFactoryEasyRdf');
...
$store = $dice->create("Saft\\Backend\\ARC2\\Store\\ARC2", $params);

/*
 * Create application to handle the REST requests
 */
$app = $dice->create('Saft\\Skeleton\\RestApplication', [$store]);
$app->run();
